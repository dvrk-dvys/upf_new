...
latest_state AS (
  SELECT w2.step AS current_status_hire, wl.status AS current_status_icims, wl.job_id, wl.person_id, w2.job_amzr_req_id, w2.cand_icims_id 
