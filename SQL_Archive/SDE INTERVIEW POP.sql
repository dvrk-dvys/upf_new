...
(
  SELECT DISTINCT location_building_name, location_city_name, location_country_name, department_name, department_id, department_org_level2, emplid, employee_login, employee_full_name, job_entry_date,
    job_tech_indicator, job_level_name, job_title_name AS Interviewer_Title, job_title_short_name, job_last_hire_date, business_unit_name, business_unit_code, employee_class_name, employee_status_description, 
    ...
    reports_to_level_7_employee_name, reports_to_level_8_employee_name, reports_to_level_10_employee_name, reports_to_supervisor_employee_name,
    DATEDIFF(month, job_last_hire_date, GETDATE()) AS "tenure_in_months", is_mghd,
    
     
    CASE WHEN is_sfi = 'Y' THEN 'Y'
    ...
    AND job_level_name IN (4, 5, 6, 7) 
    AND employee_hc_current.reports_to_level_3_employee_login IN ('davecl', 'darcie', 'gcarpe')
...
(
  SELECT location_building_name, location_city_name, location_country_name, department_name, department_id, department_org_level2, emplid, employee_login, employee_full_name, job_entry_date,
        ...
        reports_to_level_2_employee_name, reports_to_level_3_employee_name, reports_to_level_4_employee_name, reports_to_level_5_employee_name, reports_to_level_6_employee_name,
        reports_to_level_7_employee_name, reports_to_level_8_employee_name, reports_to_level_10_employee_name, reports_to_supervisor_employee_name, is_mghd, is_sfi, tenure_in_months, active_br_flag, active_brit_flag,
  ...
  SELECT location_building_name, location_city_name, location_country_name, department_name, D.department_id, department_org_level2, emplid, employee_login, employee_full_name, job_entry_date,
        job_tech_indicator, job_level_name,Interviewer_Title, job_title_short_name, open_rec_title, job_last_hire_date, business_unit_name, business_unit_code, employee_class_name, employee_status_description, 
        reports_to_level_2_employee_name, reports_to_level_3_employee_name, reports_to_level_4_employee_name, reports_to_level_5_employee_name, reports_to_level_6_employee_name,
        reports_to_level_7_employee_name, reports_to_level_8_employee_name, reports_to_level_10_employee_name, reports_to_supervisor_employee_name, is_mghd, is_sfi,
