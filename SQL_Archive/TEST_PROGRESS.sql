...
FULL OUTER JOIN (
            ...
            AND lower(hc.job_title_name) NOT LIKE '%director%'
            AND lower(hc.job_title_name) NOT LIKE '%manager%'
            AND lower(hc.job_title_name) NOT LIKE '%principal%'
            AND lower(hc.job_title_name) NOT LIKE '%mgr%'
            AND hc.employee_login <> ''
            --AND LENGTH(hc.emplid) = 6
...
WHERE 1=1
AND SYSTEMS.actor_employee_id IN ('101583269', '100017975', '020525', '100029736')
OR NOT_ACTIVE.employee_login = 'mrtrac'     
