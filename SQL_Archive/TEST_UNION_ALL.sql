WITH unionedWBRMetrics as (
    ...
    SELECT DISTINCT
            '100+ Dwelling Reqs'::VARCHAR(200) AS metric_name
            ,dr.job_id
            ,dr.job_icims_id as person_id
            --,dr.job_guid
    ...
    SELECT DISTINCT 
    'Delivery - Hires'::VARCHAR(200) AS metric_name
    --ap.application_date,
    ...
    ,NULL AS head_failure
    ,NULL AS total_sum
    ,NULL AS AS total_dwelling_time
...
SELECT  metric_name::VARCHAR(200),
