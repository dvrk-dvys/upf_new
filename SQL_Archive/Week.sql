...
,TRUNC(snapshot_end_timestamp) endday
...
INNER JOIN hrmetrics.o_reporting_days rd ON rd.calendar_day >= reqs.snapshot_begin_timestamp AND rd.calendar_day < snapshot_end_timestamp AND rd.calendar_day_of_week = 1 AND rd.reporting_year IN (2019) 
