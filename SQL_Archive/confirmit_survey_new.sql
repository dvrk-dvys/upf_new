...
--and interview.event_finish_dt::date >= dateadd(day,-90,sysdate)
and interview.event_finish_dt::date >= dateadd(day,-8,sysdate)
and hc.emplid IS NOT Null 
)
WHERE 1=1
--AND full_name = 'Andrew Liggon'
--AND full_name = 'Adam Waligorski'
--OR full_name =  'Caitlyn Edler'
--or full_name = 'Constance Howard'
