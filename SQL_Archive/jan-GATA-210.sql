SELECT 
      ...
      outcome_vote,
      CASE WHEN interviewer_vote IN ('INCLINED','STRONG_HIRE') THEN concat_job_cand END AS inclined,
      CASE WHEN interviewer_vote IN ('NOT_INCLINED','STRONG_NO_HIRE') THEN concat_job_cand END AS not_inclined,
      inclined_vote_ct,
      not_inclined_vote_ct,
      inclined_result_ct,
      not_inclined_result_ct,
      CASE WHEN r.recruiter_reports_to_level_5_employee_login = 'chaluleu' THEN 'Luli'
...
AND ia.event_start_dt >= '2017-01-01'
